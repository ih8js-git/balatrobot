...
For detailed CLI options and usage, see the [CLI Reference](https://coder.github.io/balatrobot/cli/index.md).
...
For more troubleshooting help, see the [CLI Reference](https://coder.github.io/balatrobot/cli/index.md).
